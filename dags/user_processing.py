...
def _processing_user(ti):  
    ...
    processing_user = json_normalize({
    ...
    processing_user.to_csv('/tmp/processed_user.csv', index=None, header=False)
...
# tasks/operators
    ...
    creating_table >> is_api_available >> extracting_users >> processing_users >> storing_user
